        ...
        <div className="input-area">
          ...
          <div className="forgot-password-area flex justify-between items-center mb-7">
            ...
            <Link href="/forgot-password" passhref>
              <a>
              <span className="text-base primary-text cursor-pointer">
          ...
          <div className="signin-area mb-3.5">
            ...
            {/*<Link href="#">*/}
            {/*  <div className="w-full border border-qgray-border h-[50px] flex space-x-3  justify-center bg-[#FAFAFA] items-center">*/}
            {/*    <svg*/}
            {/*      width="19"*/}
            {/*      height="20"*/}
            {/*      viewBox="0 0 19 20"*/}
